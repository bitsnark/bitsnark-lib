...
export class G2 extends EC {
    ...
    constructor() {
        const ec_a = new Complex(G2.prime, [new PrimeFieldMember(R_0), new PrimeFieldMember(R_0)]);
        let ec_b = new Complex(G2.prime, [
            new PrimeFieldMember(G2.prime, Register.hardcoded(3n)),
            new PrimeFieldMember(G2.prime, R_0)]);
        ec_b = ec_b.div(new Complex(G2.prime, [
        ...
        this.generator = this.makePoint(
            new Complex(G2.prime, [
                new PrimeFieldMember(G2.prime, G2.gen_x_r),
                new PrimeFieldMember(G2.prime, G2.gen_x_i)]),
            new Complex(G2.prime, [
                new PrimeFieldMember(G2.prime, G2.gen_y_r),
                new PrimeFieldMember(G2.prime, G2.gen_y_i)]));
    }
}
