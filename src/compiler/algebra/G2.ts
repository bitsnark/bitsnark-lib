...
const ec_b = complexField.newMember(
    vm.hardcoded('g2 ecb denom', 3n), vm.R_0)
    .div(complexField.newMember(vm.hardcoded('g2 b2', 9n), vm.hardcoded('g2 b2', 1n)));
    ...
    constructor() {
        ...
        this.generator = this.makePoint(
            complexField.newMember(
                vm.hardcoded('g2 gxr', 10857046999023057135944570762232829481370756359578518086990519993285655852781n),
                vm.hardcoded('g2 gci', 11559732032986387107991004021392285783925812861821192530917403151452391805634n)),
            complexField.newMember(
                vm.hardcoded('g2 gyr', 8495653923123431417604973247489272438418190587263600148770280649306958101930n),
                vm.hardcoded('g2 gyi', 4082367875863433681332203403145435568316851327593401208105741076214120093531n)));
    }
