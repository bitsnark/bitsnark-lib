...
export const agentConf: AgentConf = {
    ...
    keyPairs: {
        'bitsnark_prover_1': {
            schnorrPublic: parse.string('PROVER_SCHNORR_PUBLIC', 'ae2ea39bca4b6b14567e3c38b9680f6483ceeef4ae17f8dceb5a5a0866999b75'),
            schnorrPrivate: parse.string('PROVER_SCHNORR_PRIVATE', 'd4067af1132afcb352b0edef53d8aa2a5fc713df61dee31b1d937e69ece0ebf0')
        },
        'bitsnark_verifier_1': {
            schnorrPublic: parse.string('VERIFIER_SCHNORR_PUBLIC', '86ad52a51b65ab3aed9a64e7202a7aa1f2bd3da7a6a2dae0f5c8e28bda29de79'),
