...
describe("SimpleTapTree", () => {
    ...
    const testCases = [
        {
            ...
            expected: {
                ...
                scriptPubKey:
                    "5120796965d59d0259aaf81f8763bb1f000b2ddf0b333d3d0182ce11cb41f8556566",
                scriptPathControlBlocks: [
                    "c1e0dfe2300b0dd746a3f8674dfd4525623639042569d829c7f0eed9602d263e6f",
                ],
            },
        },
        {
            ...
            expected: {
                ...
                scriptPubKey:
                    "5120ba37ef408872d564fdb14630e938991f8b236cd7ea47aa06fe0aba7c1f701798",
                scriptPathControlBlocks: [
                    "c1e0dfe2300b0dd746a3f8674dfd4525623639042569d829c7f0eed9602d263e6f",
                ],
            },
        },
        {
            ...
            expected: {
                ...
                scriptPubKey:
                    "51207b9e82fad4c1e9b12b9a90b729c2e82faa8719b3278c92fd4edf26ae2eea2cc8",
                scriptPathControlBlocks: [
        ...
        },
        {
            ...
            expected: {
                ...
                scriptPubKey:
                    "512090232cdb89b1dd2b5014f4bcba9bcf55e8341bb816800b8e61f9d203bdcedb29",
                scriptPathControlBlocks: [
    ...
    it.each(testCases)("scriptPubKey test case %#", (testcase: Testcase) => {
        ...
        const scriptPubKey = tapTree.getScriptPubkey();
