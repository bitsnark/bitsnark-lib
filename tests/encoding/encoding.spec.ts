...
describe('hash', () => {
    ...
    it('should hash the input bigint the specified number of times', () => {
        expect(hash(12345678n, 2)).toBe(0x17d286b1ac05f24280a870655eac0b50b774f6b3a538fd34f3662d4d6dc9f4e9n);
    });
...
describe('hashPair', () => {
    it('should hash the pair of input bigints', () => {
        expect(hashPair(123n, 456n)).toBe(0xe03e1ee464b067e1fd0570cd3ca6829cf5041843ec151dffbc3b29340ee77045n);
    });
